...
// Adaptações do port: spinner do Serpantinum -> CircularIndicator do core,
// imports "../" removidos, ThemeBackend/Scaler via qs.extras, WebEngine LAZY
// (Loader.active só liga após a primeira abertura). Perfil/cookies/UA mantidos.
import QtQuick
