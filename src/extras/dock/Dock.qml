...
// Port para Caelestia: singletons via qs.extras; StyledWindow (name "extras-dock");
// fullscreen via OsdController/Hypr; estado de minimizados em Caching.getStateDir("dock").
    ...
    delegate: Component {
        ...
        Scope {
            ...
            StyledWindow {
                ...
                // Sem gerenciador de toplevels nos docs/clone do Caelestia: detecção via serviço Hypr.
                readonly property bool isHyprlandFullscreen: {
                    try {
                        return Hypr.focusedWorkspace?.toplevels?.values?.some(t => (t.lastIpcObject?.fullscreen ?? 0) > 1) ?? false;
                    } catch (e) {
                        return false;
                    }
                }
                readonly property bool isFullscreenActive: isOsdFullscreen || isHyprlandFullscreen
                ...
                Item {
                    ...
                    FileView {
                        ...
                        path: Caching.getStateDir("dock") + "/minimized.json"
                        watchChanges: true
