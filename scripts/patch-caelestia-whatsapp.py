#!/usr/bin/env python3
"""Integra o Drawer nativo do WhatsApp (L1) ao core do Caelestia (fork local),
de forma idempotente.

Pontos do patch (contrato congelado em docs/PORT-SPEC-WHATSAPP-V2.md, secção
"Patch do core (L2)"):
...
Uso: python3 scripts/patch-caelestia-whatsapp.py [CAELESTIA_DIR] [--dry-run]
"""
