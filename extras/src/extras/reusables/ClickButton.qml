// Portado de Serpantinum: src/quickshell/reusables/ClickButton.qml (AGPL-3.0)
// Ajuste de port: import relativo do Serpantinum -> import qs.extras (ThemeBackend/Sounds shims).
